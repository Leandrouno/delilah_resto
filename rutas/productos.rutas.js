...
const { validarDatos, validarExistencia } = require('../middlewares/productos.middleware.js');
...
module.exports = (app) => {
    ...
    app.get("/v1/productos/", async (req, res) => {
        ...
        try {
            ...
            else { res.status(200).json("El producto no Existe"); }
    ...
    app.post("/v1/productos/", validarDatos, validarExistencia, esAdmin, async (req, res) => {
    ...
    app.put("/v1/productos/", esAdmin, async (req, res) => {
    ...
    app.delete("/v1/productos/", validarDatos, esAdmin, async (req, res) => {
